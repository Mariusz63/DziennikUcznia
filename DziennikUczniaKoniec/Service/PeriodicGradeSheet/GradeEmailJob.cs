using DziennikUczniaKoniec.Controllers;
...
namespace DziennikUczniaKoniec.Service.PeriodicGradeSheet
{
    public class GradeEmailJob : IJob
    {
        ...
        Task IJob.Execute(IJobExecutionContext context)
        {
            ...
            foreach (var parent in parents)
            {
                ...
                EmailSender.Send("noreply@DziennikUczniaKoniec.com", parent.ApplicationUser, subject, html, null, true);
            }
            return null;
        }
    }
